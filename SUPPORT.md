...
- Release evidence — measured results per checkpoint, including unresolved
  limitations. It lives on the Stage 17 branch under `docs/release-evidence/`,
  because this branch carries no Stage 17 code.
