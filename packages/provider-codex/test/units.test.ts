...
describe("resume binding, reconciliation, and failure mapping", () => {
  ...
  it("makes actual managed-workspace changes authoritative", async () => {
    const grant = parseCapabilityGrant({ schemaVersion: 2, grantId: "grant-unit", projectId: "project-1", runId: null, taskId: null, attemptId: "attempt-1", snapshotId: "snapshot-1", workspaceId: "workspace-1", operations: ["workspace-read", "workspace-write"], readablePrefixes: [""], writablePrefixes: ["src"], tools: [], environmentNames: [], credentialRefFingerprints: [], controlPlaneEndpointPolicyFingerprint: null, network: { mode: "denied", egressDomains: [] }, quotas: { wallClockMs: 1_000, cpuTimeMs: null, memoryBytes: null, processCount: null, outputBytes: 1_000, diskBytes: null, fileCount: null }, issuedAt: "2026-08-03T11:00:00.000Z", expiresAt: "2026-08-03T13:00:00.000Z", nonce: "a".repeat(32), policyFingerprint: "b".repeat(64), approvalEvidenceRefs: [] });
  ...
  it("covers reconciliation unavailability, change kinds, link races, and hard limits", async () => {
    const grant = parseCapabilityGrant({ schemaVersion: 2, grantId: "grant-kinds", projectId: "project-1", runId: null, taskId: null, attemptId: "attempt-1", snapshotId: "snapshot-1", workspaceId: "workspace-1", operations: ["workspace-read", "workspace-write"], readablePrefixes: [""], writablePrefixes: [""], tools: [], environmentNames: [], credentialRefFingerprints: [], controlPlaneEndpointPolicyFingerprint: null, network: { mode: "denied", egressDomains: [] }, quotas: { wallClockMs: 1_000, cpuTimeMs: null, memoryBytes: null, processCount: null, outputBytes: 1_000, diskBytes: null, fileCount: null }, issuedAt: "2026-08-03T11:00:00.000Z", expiresAt: "2026-08-03T13:00:00.000Z", nonce: "c".repeat(32), policyFingerprint: "d".repeat(64), approvalEvidenceRefs: [] });
