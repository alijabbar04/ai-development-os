...
- **Known limitations are enumerated** in the release-evidence documents under
  `docs/release-evidence/` on the Stage 17 branch, including limitations that
  remain unresolved. They are not on `main`, which carries no Stage 17 code.
